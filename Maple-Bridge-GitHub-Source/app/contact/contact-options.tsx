...
export default function ContactOptions(){
 ...
 <div className="contact-grid" style={{gridTemplateColumns:'1fr'}}><section className="contact-card"><Mail size={32} strokeWidth={1.3}/><h2>Start a conversation</h2><p>Choose email or WhatsApp to discuss your child’s needs and the next step.</p>
